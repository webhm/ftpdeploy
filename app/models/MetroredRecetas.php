...
class MetroredRecetas extends Models implements IModels
{
    ...
    private $remitente = 'Metrored Recetas recetasmtr@hospitalmetropolitano.org';
    ...
    public function taskSendRecetas()
    {
        try {
            ...
            $sql = " SELECT * FROM ENVIO_MAIL_METRORED WHERE FECHA IS NOT NULL AND ESTADO='GEN' AND PK_TIPO='1' ORDER BY ASUNTO DESC  ";
