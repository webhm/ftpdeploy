...
//..
    ...
    public function getAccount()
    {
        ...
        try {
            ...
            if ($this->USER->PRO == 1 && $this->USER->PTE == 0 && $this->USER->MED == 0) {
                ...
                # SETEAR NOMBRE DE PROVEDORES

                if (count(explode(' ', $data['NOMBRE'])) == 0) {
                    ...
                    $n = explode(' ', $data['NOMBRE']);

                    $nombres = $n[0];

                    # Eliminamos el primer elemneto para le nombre
                    unset($n[0]);
                ...
                # SI ES PROVEEDOR
                $pte['APELLIDOS']     = $apellidos;
                $pte['NOMBRES']       = $nombres;
                $pte['DIRECCIONES']   = array($data['DIRECCION']);
                $pte['TELEFONOS']     = (is_null($data['TELEFONO1']) || is_null($data['TELEFONO2'])) ? array() : array($data['TELEFONO1'], $data['TELEFONO2']);
                $pte['CELULARES']     = (is_null($data['TELEFONO1']) || is_null($data['TELEFONO2'])) ? array() : array($data['TELEFONO1'], $data['TELEFONO2']);
