...
//..
    ...
    /**
     * Realiza la acción de autenticar al usuario auth_Api_Test
     *
     * @return array : Con información de éxito/falla al inicio de sesión.
     */
    ...
    /**
     * Devuelve banco de preguntas
     *
     */

    private function questionSec()
    {
        return array(
            'Q1' => '¿Cual es su comida favorita?',
            'Q2' => '¿Cual es el nombre de su mejor amigo del Colegio?',
            'Q3' => '¿Cual es el nombre de su abuela materna?',
            'Q4' => '¿Cual es su color favorito?',
            'Q5' => '¿Cual es su ciudad de nacimiento?',
        );
    }
    ...
    public function auth_Api_Qsec()
    {
        try {
            ...
            if ($e->getCode() == 4004) {
                ...
                # Usuario no existe en bdd debe registrarse
                return array(
                    'status' => false,
                    'message' => $e->getMessage(),
                    'errorCode' => $e->getCode(),
    ...
    /**
     * Realiza la acción de login dentro del sistema => login_Api_Test
     *
     * @return array : Con información de éxito/falla al inicio de sesión.
     */
    public function login_Api_Test(): array
    {
        try {
    ...
    private function cuentaElectronica_v2()
    {
        ...
        # Valdiar si tienes preguntas de seguridad listas
        if ($account['STATUS_QSEC'] !== '1') {

            # CUENTA SIN PREGUNATS DE SEGURDIAD
            throw new ModelsException($this->errors['notQsecAccount']['message'], $this->errors['notQsecAccount']['code']);
        ...
        if ($account['ESTADO'] == 'I') {
            ...
            $EMAIL = Helper\Strings::hiddenString($e[0]) . '@' . Helper\Strings::hiddenString($e[1], 3, 1);
