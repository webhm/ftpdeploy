    ...
    public function getMedicos()
    {
        ...
        try {
            ...
            if ($_searchField != false) {
                ...
                $sql = " SELECT cd_prestador

                , nm_prestador
         FROM prestador WHERE nm_prestador LIKE '%" . $this->searchField . "%' ";
    ...
    public function getItems()
    {
        ...
        try {
            ...
            if ($_searchField != false) {
                ...
                $sql = " SELECT CD_ITEM_AGENDAMENTO, DS_ITEM_AGENDAMENTO  from item_agendamento where sn_ativo = 'S' AND DS_ITEM_AGENDAMENTO LIKE '%" . $this->searchField . "%' ";
