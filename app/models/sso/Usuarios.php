...
use Ocrend\Kernel\Models\Traits\DBModelAuth;
...
class Usuarios extends Models implements IModels
{
    ...
    public function getAplicaciones()
    {
        ...
        # Existencia de email
        $query = $this->db->select('*', 'auth_aplicaciones');
    ...
    public function getUsuarios()
    {
        ...
        # Existencia de email
        $query = $this->db->select('*', 'auth_usuarios');

        return $query;

    }

    public function getAppDataUser($queryApp, $userApp, $documento)
    {

        $stsLogPen = "_sso/app/" . $queryApp . "/" . $userApp . ".json";
        if (@file_get_contents($stsLogPen, true) === false) {
            file_put_contents("_sso/app/" . $queryApp . "/" . $userApp . ".json", json_encode($documento), LOCK_EX);
        }
