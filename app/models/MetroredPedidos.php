...
class MetroredPedidos extends Models implements IModels
{
    ...
    private $remitente = 'Metrored Pedidos pedidosmtr@hospitalmetropolitano.org';
    ...
    public function taskSendPedidos()
    {
        try {
            ...
            $sql = " SELECT * FROM ENVIO_MAIL_METRORED  WHERE FECHA IS NOT NULL AND FECHA = '" . date('d-m-Y') . "' AND ESTADO='GEN' AND PK_TIPO='2'  ORDER BY TEXTO_FECHA DESC   ";
